...
@WebServiceClient(name = "serviceWorld", 
                  wsdlLocation = "file:/D:/work/wsc/dev/slides6/WSDLDemo/src/main/resources/demo.wsdl",
...
public class ServiceWorld extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/work/wsc/dev/slides6/WSDLDemo/src/main/resources/demo.wsdl");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:/D:/work/wsc/dev/slides6/WSDLDemo/src/main/resources/demo.wsdl");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
